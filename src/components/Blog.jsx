...
const Blog = () => {
    ...
    return(
        <div className="w-full h-screen bg-gradient-to-tl from-purple-600 to-rose-600 ">
            <Toolbox />
            <div className="flex flex-col shadow-xl text-center p-20 animate-fadein">
                <h1 className="text-rose-200">Blog</h1>

                <div className="p-4 bg-purple-300 bg-opacity-40 backdrop-blur-lg shadow-xl rounded-lg">
